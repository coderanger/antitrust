...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EveItemPrices'
        db.create_table('antitrust_eveitemprices', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prices', to=orm['antitrust.EveItem'])),
            ('region', self.gf('django.db.models.fields.IntegerField')()),
            ('mean_sell', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
            ('mean_buy', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
            ('mean_all', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
            ('median_sell', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
            ('median_buy', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
            ('median_all', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
        ))
        db.send_create_signal('antitrust', ['EveItemPrices'])


    def backwards(self, orm):
        # Deleting model 'EveItemPrices'
        db.delete_table('antitrust_eveitemprices')
